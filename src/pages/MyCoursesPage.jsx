    ...
    >
      ...
      <div className="relative h-40 bg-gradient-to-br from-neutral-100 to-neutral-200">
        ...
        <button
          onClick={onDelete}
          disabled={isDeleting}
          className="absolute top-3 left-3 p-2 bg-white/90 rounded-lg text-neutral-500 hover:text-red-500 hover:bg-white transition-all opacity-0 group-hover:opacity-100"
        >
          {isDeleting ? (
